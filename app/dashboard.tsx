...
import { BarChart3, Calendar, MoveLeft, PieChart, TrendingUp, Wallet, X } from "lucide-react-native";
...
export default function AdminDashboard() {
  ...
  return (
    <View className="flex-1 bg-white">
      ...
      {/* Header — this app's screens draw their own, the route is
          headerShown: false (see app/_layout.tsx) */}
      <View className="bg-indigo-900 pt-14 pb-6 px-5 rounded-b-3xl">
        <View className="flex-row items-center">
          ...
          <View className="w-10 h-10 rounded-full bg-indigo-800 items-center justify-center">
            <BarChart3 size={20} color="#C7D2FE" />
          </View>
        </View>
      </View>
